              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {iconLists.map((icon, index) => (
                    <div
                      key={icon}
                      className="border border-white/[0.2] rounded-full bg-black lg:2-18 lg:h-10 w-8 h-8 flex justify-center items-center "
                      style={{ transform: `translateX(-${5 * index * 2})` }}
                    >
                      <img src={img} alt={img} className="p-2" />
                    </div>
                  ))}
                </div>
                <div className="flex justify-center items-center">
                  ...
                  <FaLocationArrow className="mb-3" color="#CBACF9" />
                </div>
              </div>
            </PinContainer>
          </div>
