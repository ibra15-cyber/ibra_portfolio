      ...
      <section className="w-full py-20">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
          <Card
            ...
            description="We'll collaborate to map out your websites goals, target audience, and key functionalities. We'll discuss things like site structure, navigation, and content requirements"
          >
            <CanvasRevealEffect
              animationSpeed={5.1}
          ...
          <Card
            ...
            description="ONce we agree on the plan, I cure my lofi playlist and dive into coding. From initial sketches to polished code, I keep you updated every step of the way"
          >
            <CanvasRevealEffect
              animationSpeed={3}
          ...
          <Card
            ...
            description="This is where the amgic happens! Based on the appproved design, I'll translate everything into functional code, building your website from the ground up"
          >
            <CanvasRevealEffect
              animationSpeed={3}
